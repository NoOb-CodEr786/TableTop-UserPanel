        ...
        <div className="px-6 pt-8 pb-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-gray-600 text-sm">Welcome back, John Doe</p>
            </div>
          ...
          <div className="bg-blue-50 rounded-xl p-4 border border-blue-100">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-blue-900 font-semibold">Today's Shift</p>
                <p className="text-blue-700 text-sm">9:00 AM - 6:00 PM</p>
              </div>
              <div className="text-right">
                <p className="text-blue-900 font-semibold">{new Date().toLocaleDateString()}</p>
                <p className="text-blue-700 text-sm">{new Date().toLocaleTimeString()}</p>
              </div>
            </div>
          </div>
        </div>
