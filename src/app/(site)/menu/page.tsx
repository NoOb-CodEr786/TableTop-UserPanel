...
export default function MenuPage() {
  ...
  const {
    ...
    setCartVisible,
    setHotelAndBranch: setCartHotelAndBranch,
    initializeCart,
  } = useCartStore();
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24 mt-20">
      ...
      <div className="px-3 sm:px-6 mb-6">
        ...
        <div className="relative mb-4">
          <input
            ...
            className="w-full px-4 py-3 pl-10 bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-theme-secondary focus:border-theme-secondary text-sm sm:text-base"
          />
          <svg
        ...
        <div className="flex gap-4 sm:gap-6 mb-6 border-b border-gray-200 overflow-x-auto scrollbar-hide">
          <button
            ...
            className={`pb-3 font-semibold whitespace-nowrap transition-colors text-sm sm:text-base ${
              !menuPageSelectedCategory
                ? "text-gray-900 border-b-2 border-theme-secondary"
            ...
            {isLoadingMenuPageItems && displayItems.length > 0 && (
              <div className="absolute inset-0 bg-white/50 flex items-center justify-center z-10 rounded-xl">
                <div className="bg-white rounded-lg p-4 shadow-lg flex items-center gap-3">
                  <div className="w-5 h-5 border-2 border-theme-secondary border-t-transparent rounded-full animate-spin"></div>
                  ...
                  <div className="flex gap-3 sm:gap-4 p-3">
                    ...
                    <div className="w-27 h-27 flex-shrink-0 rounded-xl overflow-hidden relative">
                      ...
                      {item.discountPrice &&
                        item.discountPrice !== item.price && (
                          <div className="absolute top-2 right-2 bg-theme-error text-white text-xs font-bold px-2 py-1 rounded-md shadow-lg">
                    ...
                    <div className="flex-1 flex flex-col justify-between min-w-0">
                      ...
                      <div>
                        <div className="flex items-start gap-2 mb-1">
                          <div
                            className={`w-5 h-5 sm:w-6 sm:h-6 min-w-3 sm:min-w-4 border-1 rounded flex items-center justify-center mt-1 ${
                              item.foodType === "veg"
                                ? "border-green-600"
